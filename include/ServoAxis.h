...
namespace NRMKHelper
{
	...
	public:
		...
		{
			_radToCnt = _dirQ * _gearRatio * _pulsePerRevolution / (2*PI);
			_NmToCnt = _dirTau * 1000/(_ratedTau * _gearRatio);
	...
	private:
		...
		double _ratedTau;			// rated torque (read from motor catalogue)
