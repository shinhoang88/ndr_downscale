...
MatrixXd FT_TEMP_2(3,1); // EE frame force
MatrixXd FT_xyz_2(3,1); //  force xyz
...
void jacob_diffjacob (double ang1, double ang2, double ang3, double ang4, double ang5, double ang6, double ang7, double dth1, double dth2, double dth3, double dth4, double dth5, double dth6, double dth7)
{
		...
		// SIMPIFIED ISSAC
		G_jacob(0,0) = -(cos(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
						sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
						(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) -
				sin(ang1)*(sin(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
						(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
					cos(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
						cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
					(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))));

		G_jacob(0,1) =cos(ang1)*(cos(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
				(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
			sin(ang2)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
				cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))));

		G_jacob(0,2) =sin(ang3)*((L6 + LE)*sin(ang1)*sin(ang5)*sin(ang6) -
			cos(ang1)*cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) -
		cos(ang3)*((L6 + LE)*cos(ang1)*cos(ang2)*sin(ang5)*sin(ang6) +
			sin(ang1)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)));

		G_jacob(0,3) =-(sin(ang1)*sin(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
				(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) +
		cos(ang1)*(-(sin(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
			cos(ang2)*cos(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
				(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)));


		G_jacob(0,4) =(L6 + LE)*(cos(ang4)*sin(ang1)*sin(ang3)*sin(ang5) -
			cos(ang3)*(cos(ang5)*sin(ang1) + cos(ang1)*cos(ang2)*cos(ang4)*sin(ang5)) +
			cos(ang1)*(-(cos(ang2)*cos(ang5)*sin(ang3)) + sin(ang2)*sin(ang4)*sin(ang5)))*sin(ang6);


		G_jacob(0,5) =(-L6 - LE)*(sin(ang1)*(cos(ang4)*cos(ang5)*cos(ang6)*sin(ang3) +
				cos(ang3)*cos(ang6)*sin(ang5) - sin(ang3)*sin(ang4)*sin(ang6)) +
			cos(ang1)*(sin(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) +
				cos(ang2)*(-(cos(ang3)*cos(ang4)*cos(ang5)*cos(ang6)) +
				cos(ang6)*sin(ang3)*sin(ang5) + cos(ang3)*sin(ang4)*sin(ang6))));


		G_jacob(0,6) = 0;

		G_jacob(1,0) =-(sin(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
				sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
		cos(ang1)*(sin(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
				(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
			cos(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
				cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
					(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))));
		...
		G_jacob(1,1) =sin(ang1)*(cos(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
				(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
			sin(ang2)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
				cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))));
		...
		G_jacob(1,2) = cos(ang1)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
			cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) -
		cos(ang2)*sin(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
			sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)));


		G_jacob(1,3) =-(sin(ang1)*sin(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
		cos(ang2)*cos(ang3)*sin(ang1)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
			(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
		cos(ang1)*sin(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
			(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6));


		G_jacob(1,4) =(L6 + LE)*(cos(ang1)*(cos(ang3)*cos(ang5) - cos(ang4)*sin(ang3)*sin(ang5)) +
			sin(ang1)*(sin(ang2)*sin(ang4)*sin(ang5) -
				cos(ang2)*(cos(ang5)*sin(ang3) + cos(ang3)*cos(ang4)*sin(ang5))))*sin(ang6);


		G_jacob(1,5) =(L6 + LE)*(-(sin(ang1)*sin(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6))) +
			cos(ang1)*(cos(ang4)*cos(ang5)*cos(ang6)*sin(ang3) + cos(ang3)*cos(ang6)*sin(ang5) -
				sin(ang3)*sin(ang4)*sin(ang6)) -
			cos(ang2)*sin(ang1)*(cos(ang6)*sin(ang3)*sin(ang5) +
				cos(ang3)*(-(cos(ang4)*cos(ang5)*cos(ang6)) + sin(ang4)*sin(ang6))));
		...
		G_jacob(2,0) =0;
		G_jacob(2,1) =-(sin(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
							(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) +
					cos(ang2)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
						cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
							(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)));
		...
		G_jacob(2,2) =sin(ang2)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
			sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
				(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)));


		G_jacob(2,3) =-(cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
							(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) -
					cos(ang3)*sin(ang2)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
						(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6));


		G_jacob(2,4) =(L6 + LE)*(cos(ang5)*sin(ang2)*sin(ang3) +
			(cos(ang3)*cos(ang4)*sin(ang2) + cos(ang2)*sin(ang4))*sin(ang5))*sin(ang6);


		G_jacob(2,5) =(-L6 - LE)*(-(cos(ang6)*sin(ang2)*sin(ang3)*sin(ang5)) +
			cos(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) +
			cos(ang3)*sin(ang2)*(cos(ang4)*cos(ang5)*cos(ang6) - sin(ang4)*sin(ang6)));
			...
			G_jacob(3,1) = -sin(ang1);



			G_jacob(3,2) =  cos(ang1)*sin(ang2);


			G_jacob(3,3) =  -(cos(ang3)*sin(ang1)) - cos(ang1)*cos(ang2)*sin(ang3);


			G_jacob(3,4) =  -(sin(ang1)*sin(ang3)*sin(ang4)) + cos(ang1)*
				(cos(ang4)*sin(ang2) + cos(ang2)*cos(ang3)*sin(ang4));


			G_jacob(3,5) =  cos(ang4)*sin(ang1)*sin(ang3)*sin(ang5) -
						cos(ang3)*(cos(ang5)*sin(ang1) + cos(ang1)*cos(ang2)*cos(ang4)*sin(ang5)) +
						cos(ang1)*(-(cos(ang2)*cos(ang5)*sin(ang3)) + sin(ang2)*sin(ang4)*sin(ang5));


			G_jacob(3,6) =  cos(ang6)*(-(sin(ang1)*sin(ang3)*sin(ang4)) +
							cos(ang1)*(cos(ang4)*sin(ang2) + cos(ang2)*cos(ang3)*sin(ang4))) -
						(sin(ang1)*(cos(ang4)*cos(ang5)*sin(ang3) + cos(ang3)*sin(ang5)) +
							cos(ang1)*(cos(ang5)*sin(ang2)*sin(ang4) +
								cos(ang2)*(-(cos(ang3)*cos(ang4)*cos(ang5)) + sin(ang3)*sin(ang5))))*sin(ang6);
			...
			G_jacob(4,1) = cos(ang1);


			G_jacob(4,2) =sin(ang1)*sin(ang2);

			G_jacob(4,3) =  cos(ang1)*cos(ang3) - cos(ang2)*sin(ang1)*sin(ang3);


			G_jacob(4,4) =  cos(ang4)*sin(ang1)*sin(ang2) + (cos(ang2)*cos(ang3)*sin(ang1) + cos(ang1)*sin(ang3))*
				sin(ang4);


			G_jacob(4,5) =  cos(ang1)*(cos(ang3)*cos(ang5) - cos(ang4)*sin(ang3)*sin(ang5)) +
			sin(ang1)*(sin(ang2)*sin(ang4)*sin(ang5) -
				cos(ang2)*(cos(ang5)*sin(ang3) + cos(ang3)*cos(ang4)*sin(ang5)));


			G_jacob(4,6) =cos(ang6)*(cos(ang4)*sin(ang1)*sin(ang2) +
				(cos(ang2)*cos(ang3)*sin(ang1) + cos(ang1)*sin(ang3))*sin(ang4)) +
			(-(cos(ang5)*sin(ang1)*sin(ang2)*sin(ang4)) +
				cos(ang1)*(cos(ang4)*cos(ang5)*sin(ang3) + cos(ang3)*sin(ang5)) +
				cos(ang2)*sin(ang1)*(cos(ang3)*cos(ang4)*cos(ang5) - sin(ang3)*sin(ang5)))*sin(ang6);
			...
			G_jacob(5,2) = cos(ang2);

			G_jacob(5,3) =  sin(ang2)*sin(ang3);

			G_jacob(5,4) = cos(ang2)*cos(ang4) - cos(ang3)*sin(ang2)*sin(ang4);

			G_jacob(5,5) = cos(ang5)*sin(ang2)*sin(ang3) + (cos(ang3)*cos(ang4)*sin(ang2) + cos(ang2)*sin(ang4))*
				sin(ang5);


			G_jacob(5,6) =cos(ang2)*(cos(ang4)*cos(ang6) - cos(ang5)*sin(ang4)*sin(ang6)) +
						sin(ang2)*(sin(ang3)*sin(ang5)*sin(ang6) -
							cos(ang3)*(cos(ang6)*sin(ang4) + cos(ang4)*cos(ang5)*sin(ang6)));


			// diff jacobian current version by issac

			diff_jacob(0,0) = dth5*(L6 + LE)*(cos(ang1)*(-(cos(ang3)*cos(ang5)) + cos(ang4)*sin(ang3)*sin(ang5)) +
						sin(ang1)*(-(sin(ang2)*sin(ang4)*sin(ang5)) +
							cos(ang2)*(cos(ang5)*sin(ang3) + cos(ang3)*cos(ang4)*sin(ang5))))*sin(ang6) +
					dth1*sin(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
						sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))\
						- dth4*(-(sin(ang1)*sin(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
							(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
						cos(ang2)*cos(ang3)*sin(ang1)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
							(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
						cos(ang1)*sin(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
							(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) -
					dth2*sin(ang1)*(cos(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
							(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
						sin(ang2)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
							cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
								(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) -
					dth1*cos(ang1)*(sin(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
							(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
						cos(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
							cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
								(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
					dth3*(cos(ang1)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
							cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
								(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
						cos(ang2)*sin(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
							sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
								(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
					dth6*(L6 + LE)*(sin(ang1)*sin(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) -
						cos(ang1)*(cos(ang4)*cos(ang5)*cos(ang6)*sin(ang3) + cos(ang3)*cos(ang6)*sin(ang5) -
							sin(ang3)*sin(ang4)*sin(ang6)) +
						cos(ang2)*sin(ang1)*(cos(ang6)*sin(ang3)*sin(ang5) +
							cos(ang3)*(-(cos(ang4)*cos(ang5)*cos(ang6)) + sin(ang4)*sin(ang6))));

			diff_jacob(0,1) = dth5*(L6 + LE)*cos(ang1)*(cos(ang5)*sin(ang2)*sin(ang3) +
							(cos(ang3)*cos(ang4)*sin(ang2) + cos(ang2)*sin(ang4))*sin(ang5))*sin(ang6) +
						dth3*cos(ang1)*sin(ang2)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
							sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))\
							- dth6*(L6 + LE)*cos(ang1)*(-(cos(ang6)*sin(ang2)*sin(ang3)*sin(ang5)) +
							cos(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) +
							cos(ang3)*sin(ang2)*(cos(ang4)*cos(ang5)*cos(ang6) - sin(ang4)*sin(ang6))) -
						dth4*cos(ang1)*(cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
								(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) +
							cos(ang3)*sin(ang2)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
								(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) -
						dth1*sin(ang1)*(cos(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
								(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
							sin(ang2)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
								cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
									(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) -
						dth2*cos(ang1)*(sin(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
								(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
							cos(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
								cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
									(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))));
			...
			diff_jacob(0,2) = dth5*(L6 + LE)*(sin(ang1)*(cos(ang5)*sin(ang3) + cos(ang3)*cos(ang4)*sin(ang5)) +
								cos(ang1)*cos(ang2)*(-(cos(ang3)*cos(ang5)) + cos(ang4)*sin(ang3)*sin(ang5)))*sin(ang6) -
							dth4*(cos(ang3)*sin(ang1) + cos(ang1)*cos(ang2)*sin(ang3))*
								(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) - (L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
							dth2*cos(ang1)*sin(ang2)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
								sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))\
								+ dth3*(-(cos(ang1)*cos(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
									cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
								sin(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
									sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
							dth1*(cos(ang1)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
									cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
								cos(ang2)*sin(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
									sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
							dth6*(L6 + LE)*(-(cos(ang3)*(cos(ang4)*cos(ang5)*cos(ang6)*sin(ang1) +
									cos(ang1)*cos(ang2)*cos(ang6)*sin(ang5) - sin(ang1)*sin(ang4)*sin(ang6))) +
								sin(ang3)*(cos(ang6)*sin(ang1)*sin(ang5) +
									cos(ang1)*cos(ang2)*(-(cos(ang4)*cos(ang5)*cos(ang6)) + sin(ang4)*sin(ang6))));


			diff_jacob(0,3) =dth5*(L6 + LE)*(-(sin(ang1)*sin(ang3)*sin(ang4)) +
									cos(ang1)*(cos(ang4)*sin(ang2) + cos(ang2)*cos(ang3)*sin(ang4)))*sin(ang5)*sin(ang6) +
								dth4*sin(ang1)*sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
									(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) -
								dth3*(cos(ang3)*sin(ang1) + cos(ang1)*cos(ang2)*sin(ang3))*
									(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) - (L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) -
								dth4*cos(ang1)*(cos(ang4)*((L4 + (L6 + LE)*cos(ang6))*sin(ang2) +
										(L6 + LE)*cos(ang2)*cos(ang3)*cos(ang5)*sin(ang6)) +
									sin(ang4)*(cos(ang2)*cos(ang3)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang2)*sin(ang6))) -
								dth2*cos(ang1)*(cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) +
									cos(ang3)*sin(ang2)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) -
								dth1*(-(sin(ang1)*sin(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
									cos(ang2)*cos(ang3)*sin(ang1)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
									cos(ang1)*sin(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) +
								dth6*(L6 + LE)*(sin(ang1)*sin(ang3)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) -
									cos(ang1)*(cos(ang4)*(cos(ang5)*cos(ang6)*sin(ang2) + cos(ang2)*cos(ang3)*sin(ang6)) +
										sin(ang4)*(cos(ang2)*cos(ang3)*cos(ang5)*cos(ang6) - sin(ang2)*sin(ang6))));


			diff_jacob(0,4) =(L6 + LE)*(sin(ang1)*(((dth3 + dth1*cos(ang2))*cos(ang5)*sin(ang3) -
								(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4)*sin(ang5))*sin(ang6) +
								cos(ang4)*sin(ang3)*(dth6*cos(ang6)*sin(ang5) + dth5*cos(ang5)*sin(ang6))) +
							cos(ang1)*(dth6*cos(ang6)*sin(ang2)*sin(ang4)*sin(ang5) +
								(cos(ang5)*sin(ang2)*(dth2*sin(ang3) + dth5*sin(ang4)) +
								cos(ang4)*(dth4*sin(ang2) + dth1*sin(ang3))*sin(ang5))*sin(ang6) +
								cos(ang2)*(-(dth6*cos(ang5)*cos(ang6)*sin(ang3)) +
								((dth5 + dth3*cos(ang4))*sin(ang3) + dth2*sin(ang4))*sin(ang5)*sin(ang6))) +
							cos(ang3)*(-(cos(ang5)*(dth6*cos(ang6)*sin(ang1) +
									cos(ang1)*(dth1 + cos(ang2)*(dth3 + dth5*cos(ang4)))*sin(ang6))) +
								sin(ang5)*((dth5 + (dth3 + dth1*cos(ang2))*cos(ang4))*sin(ang1)*sin(ang6) +
								cos(ang1)*(dth2*cos(ang4)*sin(ang2)*sin(ang6) +
									cos(ang2)*(-(dth6*cos(ang4)*cos(ang6)) + dth4*sin(ang4)*sin(ang6))))));


			diff_jacob(0,5) = (L6 + LE)*(sin(ang1)*(cos(ang6)*sin(ang3)*
									(dth6*sin(ang4) + (dth3 + dth1*cos(ang2) + dth5*cos(ang4))*sin(ang5)) +
									cos(ang4)*(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang6) +
									cos(ang5)*(cos(ang6)*(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4) +
									dth6*cos(ang4)*sin(ang3)*sin(ang6))) +
								cos(ang1)*(dth2*cos(ang6)*sin(ang2)*sin(ang3)*sin(ang5) +
									dth5*cos(ang6)*sin(ang2)*sin(ang4)*sin(ang5) + dth4*sin(ang2)*sin(ang4)*sin(ang6) +
									dth6*cos(ang5)*sin(ang2)*sin(ang4)*sin(ang6) + dth1*sin(ang3)*sin(ang4)*sin(ang6) -
									cos(ang4)*(cos(ang6)*((dth6 + dth4*cos(ang5))*sin(ang2) +
										(dth1 + dth3*cos(ang2))*cos(ang5)*sin(ang3)) + dth2*cos(ang2)*sin(ang6)) +
									cos(ang2)*(-(cos(ang5)*cos(ang6)*(dth5*sin(ang3) + dth2*sin(ang4))) +
									sin(ang3)*(dth3*sin(ang4) + dth6*sin(ang5))*sin(ang6))) -
								cos(ang3)*(-(sin(ang1)*((dth3 + dth1*cos(ang2))*sin(ang4) + dth6*sin(ang5))*sin(ang6)) +
									cos(ang5)*(cos(ang6)*((dth5 + (dth3 + dth1*cos(ang2))*cos(ang4))*sin(ang1) +
										cos(ang1)*(dth2*cos(ang4)*sin(ang2) + dth4*cos(ang2)*sin(ang4))) +
									dth6*cos(ang1)*cos(ang2)*cos(ang4)*sin(ang6)) +
									cos(ang1)*(dth1*cos(ang6)*sin(ang5) - dth2*sin(ang2)*sin(ang4)*sin(ang6) +
									cos(ang2)*(cos(ang6)*(dth6*sin(ang4) + (dth3 + dth5*cos(ang4))*sin(ang5)) +
										dth4*cos(ang4)*sin(ang6)))));


			diff_jacob(0,6) = 0;

			diff_jacob(1,0) = dth5*(L6 + LE)*(cos(ang4)*sin(ang1)*sin(ang3)*sin(ang5) -
								cos(ang3)*(cos(ang5)*sin(ang1) + cos(ang1)*cos(ang2)*cos(ang4)*sin(ang5)) +
								cos(ang1)*(-(cos(ang2)*cos(ang5)*sin(ang3)) + sin(ang2)*sin(ang4)*sin(ang5)))*sin(ang6) +
							dth2*cos(ang1)*(cos(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
									(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
								sin(ang2)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
									cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
							dth3*(sin(ang3)*((L6 + LE)*sin(ang1)*sin(ang5)*sin(ang6) -
									cos(ang1)*cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) -
								cos(ang3)*((L6 + LE)*cos(ang1)*cos(ang2)*sin(ang5)*sin(ang6) +
									sin(ang1)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) -
							dth6*(L6 + LE)*(sin(ang1)*(cos(ang4)*cos(ang5)*cos(ang6)*sin(ang3) +
									cos(ang3)*cos(ang6)*sin(ang5) - sin(ang3)*sin(ang4)*sin(ang6)) +
								cos(ang1)*(sin(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) +
									cos(ang2)*(-(cos(ang3)*cos(ang4)*cos(ang5)*cos(ang6)) + cos(ang6)*sin(ang3)*sin(ang5) +
										cos(ang3)*sin(ang4)*sin(ang6)))) -
							dth4*(sin(ang1)*sin(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
									(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
								cos(ang1)*(sin(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) -
									cos(ang2)*cos(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)))) -
							dth1*(cos(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
									sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
								sin(ang1)*(sin(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
			...
			diff_jacob(1,1) = dth5*(L6 + LE)*sin(ang1)*(cos(ang5)*sin(ang2)*sin(ang3) +
									(cos(ang3)*cos(ang4)*sin(ang2) + cos(ang2)*sin(ang4))*sin(ang5))*sin(ang6) +
								dth3*sin(ang1)*sin(ang2)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
									sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))\
									- dth6*(L6 + LE)*sin(ang1)*(-(cos(ang6)*sin(ang2)*sin(ang3)*sin(ang5)) +
									cos(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) +
									cos(ang3)*sin(ang2)*(cos(ang4)*cos(ang5)*cos(ang6) - sin(ang4)*sin(ang6))) -
								dth4*sin(ang1)*(cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) +
									cos(ang3)*sin(ang2)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) +
								dth1*cos(ang1)*(cos(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
									sin(ang2)*((L6 + LE)*sin(ang3)*sin(ang5)*sin(ang6) -
										cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
											(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) -
								dth2*sin(ang1)*(sin(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
									cos(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
										cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
											(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))));
			...
			diff_jacob(1,2) =-(dth5*(L6 + LE)*(cos(ang1)*(cos(ang5)*sin(ang3) + cos(ang3)*cos(ang4)*sin(ang5)) +
										cos(ang2)*sin(ang1)*(cos(ang3)*cos(ang5) - cos(ang4)*sin(ang3)*sin(ang5)))*sin(ang6)) +
								dth4*(cos(ang1)*cos(ang3) - cos(ang2)*sin(ang1)*sin(ang3))*
									(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) - (L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
								dth2*sin(ang1)*sin(ang2)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
									sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))\
									+ dth1*(sin(ang3)*((L6 + LE)*sin(ang1)*sin(ang5)*sin(ang6) -
										cos(ang1)*cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
											(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) -
									cos(ang3)*((L6 + LE)*cos(ang1)*cos(ang2)*sin(ang5)*sin(ang6) +
										sin(ang1)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
											(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) -
								dth3*(cos(ang2)*sin(ang1)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
										cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
											(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6))) +
									cos(ang1)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
										sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
											(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) -
								dth6*(L6 + LE)*(cos(ang2)*sin(ang1)*
									(cos(ang4)*cos(ang5)*cos(ang6)*sin(ang3) + cos(ang3)*cos(ang6)*sin(ang5) -
										sin(ang3)*sin(ang4)*sin(ang6)) +
									cos(ang1)*(cos(ang6)*sin(ang3)*sin(ang5) +
										cos(ang3)*(-(cos(ang4)*cos(ang5)*cos(ang6)) + sin(ang4)*sin(ang6))));


			diff_jacob(1,3) = dth5*(L6 + LE)*(cos(ang4)*sin(ang1)*sin(ang2) +
									(cos(ang2)*cos(ang3)*sin(ang1) + cos(ang1)*sin(ang3))*sin(ang4))*sin(ang5)*sin(ang6) +
								dth3*(cos(ang1)*cos(ang3) - cos(ang2)*sin(ang1)*sin(ang3))*
									(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) - (L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) -
								dth6*(L6 + LE)*(sin(ang4)*(cos(ang2)*cos(ang3)*cos(ang5)*cos(ang6)*sin(ang1) +
										cos(ang1)*cos(ang5)*cos(ang6)*sin(ang3) - sin(ang1)*sin(ang2)*sin(ang6)) +
									cos(ang4)*(cos(ang5)*cos(ang6)*sin(ang1)*sin(ang2) +
										(cos(ang2)*cos(ang3)*sin(ang1) + cos(ang1)*sin(ang3))*sin(ang6))) -
								dth2*sin(ang1)*(cos(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) +
									cos(ang3)*sin(ang2)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) -
								dth4*(sin(ang4)*(cos(ang2)*cos(ang3)*(L4 + (L6 + LE)*cos(ang6))*sin(ang1) +
										cos(ang1)*(L4 + (L6 + LE)*cos(ang6))*sin(ang3) -
										(L6 + LE)*cos(ang5)*sin(ang1)*sin(ang2)*sin(ang6)) +
									cos(ang4)*((L6 + LE)*cos(ang1)*cos(ang5)*sin(ang3)*sin(ang6) +
										sin(ang1)*((L4 + (L6 + LE)*cos(ang6))*sin(ang2) +
											(L6 + LE)*cos(ang2)*cos(ang3)*cos(ang5)*sin(ang6)))) -
								dth1*(sin(ang1)*sin(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
										(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
									cos(ang1)*(sin(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
											(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) -
										cos(ang2)*cos(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
			...
			diff_jacob(1,4) =(L6 + LE)*(cos(ang1)*(((-dth3 - dth1*cos(ang2))*cos(ang5)*sin(ang3) +
										(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4)*sin(ang5))*sin(ang6) -
										cos(ang4)*sin(ang3)*(dth6*cos(ang6)*sin(ang5) + dth5*cos(ang5)*sin(ang6)) +
										cos(ang3)*(dth6*cos(ang5)*cos(ang6) -
										(dth5 + (dth3 + dth1*cos(ang2))*cos(ang4))*sin(ang5)*sin(ang6))) +
									sin(ang1)*(dth6*cos(ang6)*sin(ang2)*sin(ang4)*sin(ang5) +
										(cos(ang5)*sin(ang2)*(dth2*sin(ang3) + dth5*sin(ang4)) +
										cos(ang4)*(dth4*sin(ang2) + dth1*sin(ang3))*sin(ang5) +
										cos(ang3)*(-(dth1*cos(ang5)) + dth2*cos(ang4)*sin(ang2)*sin(ang5)))*sin(ang6) +
										cos(ang2)*(-(cos(ang5)*(dth6*cos(ang6)*sin(ang3) +
												cos(ang3)*(dth3 + dth5*cos(ang4))*sin(ang6))) +
										sin(ang5)*(((dth5 + dth3*cos(ang4))*sin(ang3) + dth2*sin(ang4))*sin(ang6) +
											cos(ang3)*(-(dth6*cos(ang4)*cos(ang6)) + dth4*sin(ang4)*sin(ang6))))));


			diff_jacob(1,5) =(-L6 - LE)*(sin(ang1)*(dth1*cos(ang3)*cos(ang6)*sin(ang5) -
									dth2*cos(ang6)*sin(ang2)*sin(ang3)*sin(ang5) -
									dth5*cos(ang6)*sin(ang2)*sin(ang4)*sin(ang5) - dth4*sin(ang2)*sin(ang4)*sin(ang6) -
									dth2*cos(ang3)*sin(ang2)*sin(ang4)*sin(ang6) -
									dth6*cos(ang5)*sin(ang2)*sin(ang4)*sin(ang6) - dth1*sin(ang3)*sin(ang4)*sin(ang6) +
									cos(ang4)*(cos(ang6)*((dth6 + (dth4 + dth2*cos(ang3))*cos(ang5))*sin(ang2) +
										(dth1 + dth3*cos(ang2))*cos(ang5)*sin(ang3) + dth5*cos(ang2)*cos(ang3)*sin(ang5)) +
									cos(ang2)*(dth2 + cos(ang3)*(dth4 + dth6*cos(ang5)))*sin(ang6)) +
									cos(ang2)*(cos(ang5)*cos(ang6)*(dth5*sin(ang3) + (dth2 + dth4*cos(ang3))*sin(ang4)) +
									cos(ang3)*cos(ang6)*(dth6*sin(ang4) + dth3*sin(ang5)) -
									sin(ang3)*(dth3*sin(ang4) + dth6*sin(ang5))*sin(ang6))) +
								cos(ang1)*(dth6*cos(ang6)*sin(ang3)*sin(ang4) + dth3*cos(ang6)*sin(ang3)*sin(ang5) +
									dth1*cos(ang2)*cos(ang6)*sin(ang3)*sin(ang5) +
									dth5*cos(ang4)*cos(ang6)*sin(ang3)*sin(ang5) + dth1*cos(ang4)*sin(ang2)*sin(ang6) +
									dth4*cos(ang4)*sin(ang3)*sin(ang6) +
									cos(ang5)*(cos(ang6)*(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4) +
									dth6*cos(ang4)*sin(ang3)*sin(ang6)) +
									cos(ang3)*((-dth5 - (dth3 + dth1*cos(ang2))*cos(ang4))*cos(ang5)*cos(ang6) +
									((dth3 + dth1*cos(ang2))*sin(ang4) + dth6*sin(ang5))*sin(ang6))));
			...
			diff_jacob(2,1) =dth5*(L6 + LE)*(-(sin(ang2)*sin(ang4)*sin(ang5)) +
								cos(ang2)*(cos(ang5)*sin(ang3) + cos(ang3)*cos(ang4)*sin(ang5)))*sin(ang6) +
							dth3*cos(ang2)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
								sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))\
								+ dth4*(sin(ang2)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
									(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)) -
								cos(ang2)*cos(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
									(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) +
							dth2*(-(cos(ang2)*(L2 + cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
									(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6))) +
								sin(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
									cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) +
										(L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))) +
							dth6*(L6 + LE)*(sin(ang2)*(cos(ang5)*cos(ang6)*sin(ang4) + cos(ang4)*sin(ang6)) +
								cos(ang2)*(cos(ang6)*sin(ang3)*sin(ang5) +
									cos(ang3)*(-(cos(ang4)*cos(ang5)*cos(ang6)) + sin(ang4)*sin(ang6))));



			diff_jacob(2,2) = dth5*(L6 + LE)*sin(ang2)*(cos(ang3)*cos(ang5) - cos(ang4)*sin(ang3)*sin(ang5))*sin(ang6) +
							dth4*sin(ang2)*sin(ang3)*(cos(ang4)*(L4 + (L6 + LE)*cos(ang6)) -
								(L6 + LE)*cos(ang5)*sin(ang4)*sin(ang6)) +
							dth6*(L6 + LE)*sin(ang2)*(cos(ang4)*cos(ang5)*cos(ang6)*sin(ang3) +
								cos(ang3)*cos(ang6)*sin(ang5) - sin(ang3)*sin(ang4)*sin(ang6)) +
							dth3*sin(ang2)*((-L6 - LE)*sin(ang3)*sin(ang5)*sin(ang6) +
								cos(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)))\
								+ dth2*cos(ang2)*((L6 + LE)*cos(ang3)*sin(ang5)*sin(ang6) +
								sin(ang3)*((L4 + (L6 + LE)*cos(ang6))*sin(ang4) + (L6 + LE)*cos(ang4)*cos(ang5)*sin(ang6)));



			diff_jacob(2,3) = cos(ang2)*((L6 + LE)*(dth6 + (dth4 + dth2*cos(ang3))*cos(ang5))*sin(ang4)*sin(ang6) -
								cos(ang4)*(dth4*L4 + (L6 + LE)*(dth4 + dth6*cos(ang5))*cos(ang6) +
									dth2*cos(ang3)*(L4 + (L6 + LE)*cos(ang6)) - dth5*L6*sin(ang5)*sin(ang6) -
									dth5*LE*sin(ang5)*sin(ang6))) +
							sin(ang2)*(cos(ang4)*(dth3*(L4 + (L6 + LE)*cos(ang6))*sin(ang3) +
									(L6 + LE)*(dth2*cos(ang5) + cos(ang3)*(dth6 + dth4*cos(ang5)))*sin(ang6)) +
								sin(ang4)*(dth2*L4 + dth2*L6*cos(ang6) + dth2*LE*cos(ang6) -
									dth3*L6*cos(ang5)*sin(ang3)*sin(ang6) - dth3*LE*cos(ang5)*sin(ang3)*sin(ang6) +
									cos(ang3)*(dth4*L4 + (L6 + LE)*(dth4 + dth6*cos(ang5))*cos(ang6) -
										dth5*(L6 + LE)*sin(ang5)*sin(ang6))));


			diff_jacob(2,4) = (L6 + LE)*(cos(ang5)*(dth6*cos(ang6)*sin(ang2)*sin(ang3) +
							(cos(ang3)*(dth3 + dth5*cos(ang4))*sin(ang2) +
							cos(ang2)*(dth2*sin(ang3) + dth5*sin(ang4)))*sin(ang6)) +
						sin(ang5)*(-(sin(ang2)*((dth5 + dth3*cos(ang4))*sin(ang3) + dth2*sin(ang4))*sin(ang6)) +
							cos(ang2)*(dth6*cos(ang6)*sin(ang4) + dth4*cos(ang4)*sin(ang6)) +
							cos(ang3)*(-(dth4*sin(ang2)*sin(ang4)*sin(ang6)) +
							cos(ang4)*(dth6*cos(ang6)*sin(ang2) + dth2*cos(ang2)*sin(ang6)))));


			diff_jacob(2,5) =(L6 + LE)*(cos(ang2)*(-(cos(ang4)*(dth6 + (dth4 + dth2*cos(ang3))*cos(ang5))*cos(ang6)) +
							cos(ang6)*(dth2*sin(ang3) + dth5*sin(ang4))*sin(ang5) +
							(dth4 + dth2*cos(ang3) + dth6*cos(ang5))*sin(ang4)*sin(ang6)) +
						sin(ang2)*((dth2*cos(ang4) - sin(ang3)*(dth3*sin(ang4) + dth6*sin(ang5)))*sin(ang6) +
							cos(ang3)*(cos(ang6)*(dth6*sin(ang4) + (dth3 + dth5*cos(ang4))*sin(ang5)) +
							dth4*cos(ang4)*sin(ang6)) +
							cos(ang5)*(cos(ang6)*((dth5 + dth3*cos(ang4))*sin(ang3) +
								(dth2 + dth4*cos(ang3))*sin(ang4)) + dth6*cos(ang3)*cos(ang4)*sin(ang6))));
			...
			diff_jacob(3,1) = -(dth1*cos(ang1));


			diff_jacob(3,2) =dth2*cos(ang1)*cos(ang2) - dth1*sin(ang1)*sin(ang2);


			diff_jacob(3,3) = (dth3 + dth1*cos(ang2))*sin(ang1)*sin(ang3) +
					cos(ang1)*((-dth1 - dth3*cos(ang2))*cos(ang3) + dth2*sin(ang2)*sin(ang3));


			diff_jacob(3,4) = -(sin(ang1)*(cos(ang4)*(dth1*sin(ang2) + dth4*sin(ang3)) +
							(dth3 + dth1*cos(ang2))*cos(ang3)*sin(ang4))) +
					cos(ang1)*((-((dth4 + dth2*cos(ang3))*sin(ang2)) - dth1*sin(ang3))*sin(ang4) +
						cos(ang2)*((dth2 + dth4*cos(ang3))*cos(ang4) - dth3*sin(ang3)*sin(ang4)));


			diff_jacob(3,5) = sin(ang1)*((dth3 + dth1*cos(ang2) + dth5*cos(ang4))*cos(ang5)*sin(ang3) +
						(cos(ang3)*(dth5 + (dth3 + dth1*cos(ang2))*cos(ang4)) -
							(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4))*sin(ang5)) +
					cos(ang1)*(cos(ang5)*sin(ang2)*(dth2*sin(ang3) + dth5*sin(ang4)) +
						(cos(ang4)*(dth4*sin(ang2) + (dth1 + dth3*cos(ang2))*sin(ang3)) +
							cos(ang2)*(dth5*sin(ang3) + dth2*sin(ang4)))*sin(ang5) +
						cos(ang3)*((-dth1 - cos(ang2)*(dth3 + dth5*cos(ang4)))*cos(ang5) +
							(dth2*cos(ang4)*sin(ang2) + dth4*cos(ang2)*sin(ang4))*sin(ang5)));


			diff_jacob(3,6) =-(sin(ang1)*((-(cos(ang5)*(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4)) -
							sin(ang3)*(dth6*sin(ang4) + (dth3 + dth1*cos(ang2))*sin(ang5)))*sin(ang6) +
							cos(ang3)*(cos(ang6)*((dth3 + dth1*cos(ang2))*sin(ang4) + dth6*sin(ang5)) +
							dth5*cos(ang5)*sin(ang6)) +
							cos(ang4)*(cos(ang6)*(dth1*sin(ang2) + (dth4 + dth6*cos(ang5))*sin(ang3)) +
							((dth3 + dth1*cos(ang2))*cos(ang3)*cos(ang5) - dth5*sin(ang3)*sin(ang5))*sin(ang6))))\
						+ cos(ang1)*(-(cos(ang6)*((dth4 + dth2*cos(ang3) + dth6*cos(ang5))*sin(ang2) +
							dth1*sin(ang3))*sin(ang4)) -
						(cos(ang4)*((dth6 + (dth4 + dth2*cos(ang3))*cos(ang5))*sin(ang2) +
								dth1*cos(ang5)*sin(ang3)) +
							(dth1*cos(ang3) - sin(ang2)*(dth2*sin(ang3) + dth5*sin(ang4)))*sin(ang5))*sin(ang6) +
						cos(ang2)*(-(cos(ang6)*sin(ang3)*(dth3*sin(ang4) + dth6*sin(ang5))) -
							(cos(ang5)*(dth5*sin(ang3) + (dth2 + dth4*cos(ang3))*sin(ang4)) +
								cos(ang3)*(dth6*sin(ang4) + dth3*sin(ang5)))*sin(ang6) +
							cos(ang4)*((dth2 + cos(ang3)*(dth4 + dth6*cos(ang5)))*cos(ang6) -
								(dth3*cos(ang5)*sin(ang3) + dth5*cos(ang3)*sin(ang5))*sin(ang6))));



			diff_jacob(4,0) = 0;

			diff_jacob(4,1) =-(dth1*sin(ang1));


			diff_jacob(4,2) =dth2*cos(ang2)*sin(ang1) + dth1*cos(ang1)*sin(ang2);


			diff_jacob(4,3) = (-dth1 - dth3*cos(ang2))*cos(ang3)*sin(ang1) +
					(-(cos(ang1)*(dth3 + dth1*cos(ang2))) + dth2*sin(ang1)*sin(ang2))*sin(ang3);


			diff_jacob(4,4) = -(sin(ang1)*((dth4 + dth2*cos(ang3))*sin(ang2) + dth1*sin(ang3))*sin(ang4)) +
					cos(ang1)*(cos(ang4)*(dth1*sin(ang2) + dth4*sin(ang3)) + dth3*cos(ang3)*sin(ang4)) +
					cos(ang2)*((dth2 + dth4*cos(ang3))*cos(ang4)*sin(ang1) +
						(dth1*cos(ang1)*cos(ang3) - dth3*sin(ang1)*sin(ang3))*sin(ang4));


			diff_jacob(4,5) = cos(ang1)*((-dth3 - dth1*cos(ang2) - dth5*cos(ang4))*cos(ang5)*sin(ang3) +
						(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4)*sin(ang5)) +
					sin(ang1)*(cos(ang5)*sin(ang2)*(dth2*sin(ang3) + dth5*sin(ang4)) +
						(cos(ang4)*(dth4*sin(ang2) + (dth1 + dth3*cos(ang2))*sin(ang3)) +
							cos(ang2)*(dth5*sin(ang3) + dth2*sin(ang4)))*sin(ang5)) -
					cos(ang3)*((dth1 + cos(ang2)*(dth3 + dth5*cos(ang4)))*cos(ang5)*sin(ang1) +
						(cos(ang1)*(dth5 + (dth3 + dth1*cos(ang2))*cos(ang4)) -
							sin(ang1)*(dth2*cos(ang4)*sin(ang2) + dth4*cos(ang2)*sin(ang4)))*sin(ang5));


			diff_jacob(4,6) = -(sin(ang1)*(cos(ang6)*((dth4 + dth2*cos(ang3) + dth6*cos(ang5))*sin(ang2) + dth1*sin(ang3))*
							sin(ang4) + (cos(ang4)*((dth6 + (dth4 + dth2*cos(ang3))*cos(ang5))*sin(ang2) +
								dth1*cos(ang5)*sin(ang3)) +
							(dth1*cos(ang3) - sin(ang2)*(dth2*sin(ang3) + dth5*sin(ang4)))*sin(ang5))*sin(ang6)))\
						+ cos(ang1)*((-(cos(ang5)*(dth1*sin(ang2) + dth4*sin(ang3))*sin(ang4)) -
							sin(ang3)*(dth6*sin(ang4) + dth3*sin(ang5)))*sin(ang6) +
						cos(ang3)*(cos(ang6)*(dth3*sin(ang4) + dth6*sin(ang5)) + dth5*cos(ang5)*sin(ang6)) +
						cos(ang4)*(cos(ang6)*(dth1*sin(ang2) + (dth4 + dth6*cos(ang5))*sin(ang3)) +
							(dth3*cos(ang3)*cos(ang5) - dth5*sin(ang3)*sin(ang5))*sin(ang6))) +
					cos(ang2)*(dth1*cos(ang1)*(cos(ang3)*cos(ang6)*sin(ang4) - sin(ang3)*sin(ang5)*sin(ang6)) -
						sin(ang1)*(cos(ang6)*sin(ang3)*(dth3*sin(ang4) + dth6*sin(ang5)) +
							(cos(ang5)*(dth5*sin(ang3) + (dth2 + dth4*cos(ang3))*sin(ang4)) +
								cos(ang3)*(dth6*sin(ang4) + dth3*sin(ang5)))*sin(ang6)) +
						cos(ang4)*((dth2 + cos(ang3)*(dth4 + dth6*cos(ang5)))*cos(ang6)*sin(ang1) +
							(dth1*cos(ang1)*cos(ang3)*cos(ang5) -
								sin(ang1)*(dth3*cos(ang5)*sin(ang3) + dth5*cos(ang3)*sin(ang5)))*sin(ang6)));
			...
			diff_jacob(5,2) = -(dth2*sin(ang2));

			diff_jacob(5,3) =dth3*cos(ang3)*sin(ang2) + dth2*cos(ang2)*sin(ang3);

			diff_jacob(5,4) =(-dth2 - dth4*cos(ang3))*cos(ang4)*sin(ang2) +
					(-(cos(ang2)*(dth4 + dth2*cos(ang3))) + dth3*sin(ang2)*sin(ang3))*sin(ang4);


			diff_jacob(5,5) = -(sin(ang2)*((dth5 + dth3*cos(ang4))*sin(ang3) + dth2*sin(ang4))*sin(ang5)) +
					cos(ang2)*(cos(ang5)*(dth2*sin(ang3) + dth5*sin(ang4)) + dth4*cos(ang4)*sin(ang5)) +
					cos(ang3)*((dth3 + dth5*cos(ang4))*cos(ang5)*sin(ang2) +
						(dth2*cos(ang2)*cos(ang4) - dth4*sin(ang2)*sin(ang4))*sin(ang5));


			diff_jacob(5,6) =cos(ang2)*((-dth4 - dth2*cos(ang3) - dth6*cos(ang5))*cos(ang6)*sin(ang4) +
						(dth2*sin(ang3) + dth5*sin(ang4))*sin(ang5)*sin(ang6)) +
					sin(ang2)*(cos(ang6)*sin(ang3)*(dth3*sin(ang4) + dth6*sin(ang5)) +
						(cos(ang5)*(dth5*sin(ang3) + (dth2 + dth4*cos(ang3))*sin(ang4)) +
							cos(ang3)*(dth6*sin(ang4) + dth3*sin(ang5)))*sin(ang6)) -
					cos(ang4)*((dth2 + cos(ang3)*(dth4 + dth6*cos(ang5)))*cos(ang6)*sin(ang2) +
						(cos(ang2)*(dth6 + (dth4 + dth2*cos(ang3))*cos(ang5)) -
							sin(ang2)*(dth3*cos(ang5)*sin(ang3) + dth5*cos(ang3)*sin(ang5)))*sin(ang6));
...
if (axis == 5)

	{
			...
			al_0[5] = 13.0009*0.7; //191115 *0.8 added
			al_1[5] = -4.7344;
			av_s[5] = -0.0198;
			sig_2[5] = 47.0259;
...
void demo(void *arg)
{
	...
	KnVec << 400 ,400, 400,400, 400,500,20;//200, 200, 200, 20, 10, 10,10; // double kp[7]={500,1200,200,800,300,500,10};
	Kn = KnVec.asDiagonal();

	DnVec << 40, 40, 40, 40, 40, 40,10; //kd[7]={40,80,20,80,20,40,5};
	Dn = DnVec.asDiagonal();
  // impedance model
	//Given desired mass matrix
	Md_matrix_6 << 	40, 0, 	0,0,0,0,
                     0, 40, 0,0,0,0,
                     0, 0, 40,0,0,0,
                     0, 0, 	0,80,0,0,
                     0, 0, 	0,0,80,0,
...
*/
    ...
    current_theta(6,0) = th7;
		...
		//Quat_compute(ROT_0e); // output: scl (scalar) ,espp (vector)
		//scl_c = scl;
		//espp_c = espp;
		...
		for (int i=0; i<7; i++)
		{
			n_theta_err1(i,0) = current_theta(i,0)- desired_theta(i,0);//q[i] ;desired_theta(i,0);//
	...
	//*****************************************************************currrent pos*****************************************************************************************************
		...
		c_vel = G_jacob*ang_vel; // result : velocity & euler angle derivative
		...
		*/
		...
		Quat_compute(ROT_ed); // output: scl (scalar) ,espp (vector)

		err_position_3 =ROT_0e*espp;
		err_velocity_3 = ROT_vel_C - ROT_vel_d;
	...
	//*********************************************** F/T Sensor processing ************************************************************************
	 ...
	 for (int i=0; i<6; i++)
		...
		FT_xyz =ROT_0e*FT_TEMP;//I*FT_TEMP; //;ROT_0d*FT_TEMP;
		...
		h_0e(3,0) =0;//FT_xyz_2(0,0); // x moment - not sure
		h_0e(4,0) =0;//FT_xyz_2(1,0); // y moment
		h_0e(5,0) =0;//FT_xyz_2(2,0); // z moment
		...
		//*******************************************************************************************************************************************
		Trans_Jacob = G_jacob.transpose();
		Mass_Matrix(th1,th2,th3,th4,th5,th6,th7);

		cartesian_Mass = (G_jacob*M_matrix.inverse()*G_jacob.transpose()).inverse(); // caresian mass matrix 6x6

		//======================impedance===============================================

		//done
		//Given desired mass matrix
		//Md_matrix_6 = cartesian_Mass;

		err_position(3,0) = err_position_3(0,0);
		err_position(4,0) = err_position_3(1,0);
		err_position(5,0) = err_position_3(2,0);

		err_velocity(3,0)=err_velocity_3(0,0);
		err_velocity(4,0)=err_velocity_3(1,0);
		err_velocity(5,0)=err_velocity_3(2,0);


		resolved_acc = 0*d_acc - Md_matrix_6.inverse()*(kd_matrix_6*err_velocity +kp_matrix_6*err_position) + Md_matrix_6.inverse()*h_0e;
		...
		//======================active stiffness===============================================
		/*
		resolved_acc = -(kd_matrix_6*err_velocity + kp_matrix_6*err_position) ;


		acc_o =   (-0.01*kd_matrix_3*err_velocity_3 + kp_matrix_3*err_position_3 ) ; //(T_e_de_matrix.transpose()).inverse()


		resolved_acc(3,0) = acc_o(0,0);
		resolved_acc(4,0) = acc_o(1,0);
		resolved_acc(5,0) = acc_o(2,0);


		input_y =h_0e + (resolved_acc);// - diff_jacob*ang_vel) ;
		*/
		//=====================================================================
		...
		// Prj_matrix = I7-Trans_Jacob*cartesian_Mass*G_jacob*M_matrix.inverse();
		Prj_matrix = I7-Trans_Jacob*(M_matrix.inverse()*G_jacob.transpose()*cartesian_Mass).transpose();

		Tau_stif =Prj_matrix* (-Kn*n_theta_err1 - Dn*n_dtheta_err1);
		// G_matrix -> already in  subsystem
		Tau_I=G_jacob.transpose()*input_y  + Tau_stif;//(I7-Jacob.transpose()*Md_matrix_6*Jacob*M_matrix.inverse())*Tau_stif; // B(q)*y + N(q,q')

		//checkval=G_jacob.transpose()*input_y;
		//checkval_2=input_y;
		...
		Firction_tq[6] = Friction_LG[6]*0.5;
...
{
	rt_task_set_periodic(NULL, TM_NOW, (int)ms(200));	// period = 1 (msec)
