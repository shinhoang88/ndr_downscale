...
ec_sync_info_t Robotous_RFT_EC02_syncs[] = {
	{0, EC_DIR_INPUT, 2, Robotous_RFT_EC02_pdos + 0, EC_WD_ENABLE}, 
	{0xff}
};
// ec_sync_info_t Robotous_RFT_EC02_syncs[] = {
// 	{3, EC_DIR_INPUT, 2, Robotous_RFT_EC02_pdos}, 
// 	{0xff}
// };
...
// 	{2, EC_DIR_OUTPUT, 1, Servotronix_motion_control_ltd__CDHD_pdos + 0, EC_WD_ENABLE}, 
// 	{3, EC_DIR_INPUT	, 6, Servotronix_motion_control_ltd__CDHD_pdos + 1, EC_WD_ENABLE}, 
// 	{0xff}
// };
